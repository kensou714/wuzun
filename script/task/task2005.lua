...
local task_id=const.TASK_ID_SHILIAN;
...
local task_data={
	ttype="裁决",		focus=true,		autogo=false,
	[1	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[2	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[3	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[4	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[5	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[6	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[7	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[8	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[9	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[10	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[11	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
	[12	]={ award={	{name="经验",		num=function(target,player) return to_exp(player);end, },{name="真气",		num=function(target,player) return to_hunj(player);end, },	},},
};
...
for i=1,#task_data do
	...
	task_data[i].need_map='slzd';
	task_data[i].name="裁决之地"..i.. "层";
end
...
function check_done_talk(player,param)
	if nil == string.find(player:get_map():get_id(),"slzd") then
		return ;
	end
	player:find_road_goto(player:get_map():get_id(),23,43,"裁决之地使者");
...
for i=1,#task_data do
	...
	task_state_data[task.util.ts(td.tid,const.TSCOMP)].shortdesp=function (target,player)
		...
		local ret = "<s='d'>您已经通关本层裁决!</s>\n";
		ret = ret .. show_award(target,player,td.award);
		ret = ret .. "<a href='event:click_T2001Done'>找裁决之地使者领取奖励</a>";
		return ret;
	end;
	task_state_data[task.util.ts(td.tid,const.TSCOMP)].desp=function (target,player) return "恭喜您成功通关裁决之地!";end;
