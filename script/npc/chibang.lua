...
-- 	npc:echo([[--------------------------------------
-- <font color="#FFff00">您好,我是管理翅膀的使者!</font>
-- --------------------------------------
...
-- --------------------------------------
-- ]]);
	newgui.wing.showpanel(player);
end

function onTalkcbsj(npc,player)
	npc:echo([[---------------------------------------
         <b><font color="#ccbb77" size="14px">翅膀升级兑换列表</font></b>
---------------------------------------
<font color="#ffff00">请选择您想升级的翅膀:</font>
---------------------------------------
...
---------------------------------------
                   　　<a href="event:talk_cbsj2">下一页</a>  <a href="event:talk_100">返回主页</a>
---------------------------------------
]]);
end
...
function onTalksj1jcb(npc,player)
	...
	onTalkcbsj(npc,player);
end

function onTalkcbsj2(npc,player)
	npc:echo([[---------------------------------------
         <b><font color="#ccbb77" size="14px">翅膀升级兑换列表</font></b>
---------------------------------------
...
---------------------------------------
                   　　<a href="event:talk_cbsj">上一页</a>  <a href="event:talk_100">返回主页</a>
---------------------------------------
]]);
end


function onTalksj2jcb(npc,player) cbsjxt(npc,player,160001,"二级灵羽","精灵羽(1级)","虹霓羽(2级)",160002,1) end
function onTalksj3jcb(npc,player) cbsjxt(npc,player,160002,"三级灵羽","虹霓羽(2级)","碧焰羽(3级)",160003,1) end
function onTalksj4jcb(npc,player) cbsjxt(npc,player,160003,"四级灵羽","碧焰羽(3级)","赤霞翼(4级)",160004,1) end
function onTalksj5jcb(npc,player) cbsjxt(npc,player,160004,"五级灵羽","赤霞翼(4级)","冥光翼(5级)",160005,1) end
function onTalksj6jcb(npc,player) cbsjxt(npc,player,160005,"六级灵羽","冥光翼(5级)","苍龙翼(6级)",160006,1) end
function onTalksj7jcb(npc,player) cbsjxt(npc,player,160006,"七级灵羽","苍龙翼(6级)","金天圣羽(7级)",160007,2) end
function onTalksj8jcb(npc,player) cbsjxt(npc,player,160007,"八级灵羽","金天圣羽(7级)","烈焰炽羽(8级)",160008,2) end
function onTalksj9jcb(npc,player) cbsjxt(npc,player,160008,"九级灵羽","烈焰炽羽(8级)","帝霄仙羽(9级)",160009,2) end
function onTalksj10jcb(npc,player) cbsjxt(npc,player,160009,"十级灵羽","帝霄仙羽(9级)","天皇神翼(10级)",160010,2) end
function onTalksj11jcb(npc,player) cbsjxt(npc,player,160010,"十一级灵羽","天皇神翼(10级)","九天羽皇(11级)",160011,2) end
function onTalksj12jcb(npc,player) cbsjxt(npc,player,160011,"十二级灵羽","九天羽皇(11级)","诛神凤翎(12级)",160012,2) end
function onTalksj13jcb(npc,player) cbsjxt(npc,player,160012,"十三级灵羽","诛神凤翎(12级)","炽天使之翼(13级)",160013,2) end

function cbsjxt(npc,player,a,b,c,d,e,f)
	if a and b and c and d and e and f then
		...
		if f==1 then onTalkcbsj(npc,player); end
		if f==2 then onTalkcbsj2(npc,player); end
	end
end

function onTalklyhc(npc,player)
	npc:echo([[---------------------------------------
         <b><font color="#ccbb77" size="14px">灵羽合成兑换列表</font></b>
---------------------------------------
<font color="#ffff00">请选择您想合成的灵羽:</font>
---------------------------------------
<font color="#ffff00">友情提醒:</font> <font color="#ffaa00">灵羽合成的成功率为100%</font>
---------------------------------------
...
---------------------------------------
                   　　<a href="event:talk_lyhc2">下一页</a>  <a href="event:talk_100">返回主页</a>
---------------------------------------
]]);
end

function onTalklyhc2(npc,player)
	npc:echo([[---------------------------------------
         <b><font color="#ccbb77" size="14px">灵羽合成兑换列表</font></b>
---------------------------------------
<font color="#ffff00">请选择您想合成的灵羽:</font>
...
---------------------------------------
                   　　<a href="event:talk_lyhc">上一页</a>  <a href="event:talk_100">返回主页</a>
---------------------------------------
]]);
end


function onTalkhc2jly(npc,player) lyhcxt(npc,player,"一级灵羽","二级灵羽",1,3,10) end
function onTalkhc2jly10(npc,player) lyhcxt(npc,player,"一级灵羽","二级灵羽",1,30,100) end
function onTalkhc2jly50(npc,player) lyhcxt(npc,player,"一级灵羽","二级灵羽",1,150,500) end

function onTalkhc3jly(npc,player) lyhcxt(npc,player,"二级灵羽","三级灵羽",1,3,10) end
function onTalkhc3jly10(npc,player) lyhcxt(npc,player,"二级灵羽","三级灵羽",1,30,100) end
function onTalkhc3jly50(npc,player) lyhcxt(npc,player,"二级灵羽","三级灵羽",1,150,500) end

function onTalkhc4jly(npc,player) lyhcxt(npc,player,"三级灵羽","四级灵羽",1,3,10) end
function onTalkhc4jly10(npc,player) lyhcxt(npc,player,"三级灵羽","四级灵羽",1,30,100) end
function onTalkhc4jly50(npc,player) lyhcxt(npc,player,"三级灵羽","四级灵羽",1,150,500) end

function onTalkhc5jly(npc,player) lyhcxt(npc,player,"四级灵羽","五级灵羽",1,3,10) end
function onTalkhc5jly10(npc,player) lyhcxt(npc,player,"四级灵羽","五级灵羽",1,30,100) end
function onTalkhc5jly50(npc,player) lyhcxt(npc,player,"四级灵羽","五级灵羽",1,150,500) end

function onTalkhc6jly(npc,player) lyhcxt(npc,player,"五级灵羽","六级灵羽",1,3,10) end
function onTalkhc6jly10(npc,player) lyhcxt(npc,player,"五级灵羽","六级灵羽",1,30,100) end
function onTalkhc6jly50(npc,player) lyhcxt(npc,player,"五级灵羽","六级灵羽",1,150,500) end

function onTalkhc7jly(npc,player) lyhcxt(npc,player,"六级灵羽","七级灵羽",1,3,10) end
function onTalkhc7jly10(npc,player) lyhcxt(npc,player,"六级灵羽","七级灵羽",1,30,100) end
function onTalkhc7jly50(npc,player) lyhcxt(npc,player,"六级灵羽","七级灵羽",1,150,500) end

function onTalkhc8jly(npc,player) lyhcxt(npc,player,"七级灵羽","八级灵羽",2,3,10) end
function onTalkhc8jly10(npc,player) lyhcxt(npc,player,"七级灵羽","八级灵羽",2,30,100) end
function onTalkhc8jly50(npc,player) lyhcxt(npc,player,"七级灵羽","八级灵羽",2,150,500) end

function onTalkhc9jly(npc,player) lyhcxt(npc,player,"八级灵羽","九级灵羽",2,3,10) end
function onTalkhc9jly10(npc,player) lyhcxt(npc,player,"八级灵羽","九级灵羽",2,30,100) end
function onTalkhc9jly50(npc,player) lyhcxt(npc,player,"八级灵羽","九级灵羽",2,150,500) end

function onTalkhc10jly(npc,player) lyhcxt(npc,player,"九级灵羽","十级灵羽",2,3,10) end
function onTalkhc10jly10(npc,player) lyhcxt(npc,player,"九级灵羽","十级灵羽",2,30,100) end
function onTalkhc10jly50(npc,player) lyhcxt(npc,player,"九级灵羽","十级灵羽",2,150,500) end

function onTalkhc11jly(npc,player) lyhcxt(npc,player,"十级灵羽","十一级灵羽",2,3,10) end
function onTalkhc11jly10(npc,player) lyhcxt(npc,player,"十级灵羽","十一级灵羽",2,30,100) end
function onTalkhc11jly50(npc,player) lyhcxt(npc,player,"十级灵羽","十一级灵羽",2,150,500) end

function onTalkhc12jly(npc,player) lyhcxt(npc,player,"十一级灵羽","十二级灵羽",2,3,10) end
function onTalkhc12jly10(npc,player) lyhcxt(npc,player,"十一级灵羽","十二级灵羽",2,30,100) end
function onTalkhc12jly50(npc,player) lyhcxt(npc,player,"十一级灵羽","十二级灵羽",2,150,500) end

function onTalkhc13jly(npc,player) lyhcxt(npc,player,"十二级灵羽","十三级灵羽",2,3,10) end
function onTalkhc13jly10(npc,player) lyhcxt(npc,player,"十二级灵羽","十三级灵羽",2,30,100) end
function onTalkhc13jly50(npc,player) lyhcxt(npc,player,"十二级灵羽","十三级灵羽",2,150,500) end

function lyhcxt(npc,player,a,b,c,d,e)
	if a and b and c and d and e then
		if player:num_bag_black() >= 1 then
			if player:get_vcoin() >= e then
				if player:num_item(a,1) >= d then
					...
					player:add_item_log(b,243,(e/10));
		...
		if c==1 then onTalklyhc(npc,player); end
		if c==2 then onTalklyhc2(npc,player); end
	end
end